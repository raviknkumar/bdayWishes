<template>
  <div class="container h-100" style="height: inherit;">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div
        class="col-4 col-sm-3 col-md-2 col-lg-2 col-xl-2 text-center"
        id="logo-gift"
      >
        <img
          src="https://img.icons8.com/color/100/000000/gift.png"
          id="logo-hexagon"
      ...
      <div
        class="col-6 col-sm-4 col-md-4 col-xl-3 col-lg-2 align-middle"
        style="display: flex;flex-direction: column"
      >
        <span
          id="logo-circle"
          style="color: black;margin-left: 1vw"
